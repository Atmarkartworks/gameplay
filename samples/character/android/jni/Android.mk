...
# external-deps
GAMEPLAY_DEPS := $(call my-dir)/../../../../../gameplay-deps/libs/android/$(TARGET_ARCH_ABI)

# libgameplay
LOCAL_PATH := $(call my-dir)/../../../../jniLibs/$(TARGET_ARCH_ABI)
include $(CLEAR_VARS)
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../external-deps/include $(LOCAL_PATH)/../../../gameplay/src
